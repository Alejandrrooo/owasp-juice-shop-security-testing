...
test ('removeProductFromCart', async ({page}) =>{
    ...
    const deleteButton = appleJuiceRow
        .locator('.mat-column-remove button')

    await deleteButton.click()

    await expect(appleJuiceRow).not.toBeVisible()
    ...
    //const deleteProduct = page.locator('#svg-inline--fa fa-trash-alt fa-w-14')
